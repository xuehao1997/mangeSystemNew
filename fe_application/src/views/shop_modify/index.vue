  ...
  <div class="shop-add-box">
    ...
    >
      ...
      <el-form-item label="详细地址" prop="address" >
        <el-input v-model="$route.query.address" name = "address"></el-input>
      </el-form-item>
      <el-form-item label="联系电话" prop="phone">
        <el-input v-model="$route.query.phone" name = "phone"></el-input>
      </el-form-item>
      <el-form-item label="店铺简介" prop="info">
        <el-input v-model="$route.query.info" name = "info"></el-input>
      </el-form-item>
      <el-form-item label="店铺标语" prop="slogan">
        <el-input v-model="$route.query.slogan" name = "slogan"></el-input>
      </el-form-item>
...
export default {
  ...
  mounted () {
   const { name,feature,delivery,price,startTime,endTime,logoUrl,manageUrl,diningUrl } = this.$route.query
